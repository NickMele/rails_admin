    ...
    def field_wrapper_for(field, nested_in)
      if field.label
        ...
        unless nested_field_association?(field, nested_in)
          @template.content_tag(:div, class: "form-group control-group #{field.type_css_class} #{field.css_class} #{field.required_css_class} #{'error' if field.errors.present?}", id: "#{dom_id(field)}_field") do
